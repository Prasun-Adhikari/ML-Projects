...
def update_weights(weights_0_1: np.ndarray, weights_1_2: np.ndarray, 
    ...
    layer1 = tanh(weights_0_1.dot(layer0)) * dropout_mask * 2
    layer2 = softmax(weights_1_2.dot(layer1))
    delta2 = (layer2 - layer2_exp) / N_OUTPUTS
    delta1 = weights_1_2.T.dot(delta2.reshape(N_OUTPUTS, 1)).T  * tanh_der(layer1) * dropout_mask
